...
if (isset($_GET['success']) && $_GET['success'] == 1) {
    $mensagem_sucesso = "🎉 Chamado aberto com sucesso! Ele já está na lista.";
}
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (successAlert) {
                ...
                setTimeout(function() {
                    // Adiciona uma classe para iniciar a transição de sumiço (opcional, mas profissional)
                    successAlert.style.opacity = '0';
                    successAlert.style.transition = 'opacity 0.5s ease-out';
                }, 3000); // Começa a sumir após 3 segundos

                // Remove o elemento da DOM completamente após a transição
                setTimeout(function() {
                    successAlert.remove();
                }, 3500); // 3.5 segundos (3s do delay + 0.5s da transição)
            }
        });
    </script>
</body>
